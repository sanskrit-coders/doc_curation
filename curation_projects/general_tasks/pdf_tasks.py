...
if __name__ == '__main__':
    ...
    doc_curation.pdf.drive_ocr.split_and_ocr_on_drive(pdf_path="/home/vvasuki/Documents/books/granthasangrahaH/AgamaH/tantrasAraH_jayaratha-TIkA-sahitaH.pdf", small_pdf_pages=10, start_page=1, detext=False)
