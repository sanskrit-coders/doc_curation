...
if __name__ == '__main__':
    ...
    doc_curation.pdf.drive_ocr.split_and_ocr_on_drive(pdf_path="/home/vvasuki/Documents/books/granthasangrahaH/paganology/The_Will_to_Power.pdf", small_pdf_pages=10, detext=True)
