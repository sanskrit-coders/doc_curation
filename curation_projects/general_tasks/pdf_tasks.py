...
if __name__ == '__main__':
    pass
    doc_curation.pdf.drive_ocr.split_and_ocr_on_drive(pdf_path="/home/vvasuki/Documents/books/granthasangrahaH/history/gulAb-singh-role.pdf", small_pdf_pages=10, start_page=1, detext=False)
