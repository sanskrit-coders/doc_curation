...
if __name__ == '__main__':
  ...
  library.apply_function(fn=MdFile.migrate_and_include_shlokas, dir_path="/home/vvasuki/vishvAsa/kalpAntaram/content/smRtiH/manuH/12.md", shloka_id_maker=shloka_id_maker, include_maker=include_maker, include_path_maker=lambda x: include_path_maker(title=x, dest_dir="/home/vvasuki/vishvAsa/kalpAntaram/static/smRtiH/manuH/vishvAsa_prastutiH/12/"), title_before_include="### %s", dry_run=False)
