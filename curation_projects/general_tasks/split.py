...
if __name__ == '__main__':
  ...
  # देवनागरी
  library.apply_function(fn=MdFile.split_to_bits, dir_path="/home/vvasuki/vishvAsa/mImAMsA/content/pUrvA/granthAH/shabara-bhAShyam/06", frontmatter_type=MdFile.TOML, dry_run=False, source_script=sanscript.DEVANAGARI,  title_index_pattern=None) # 
