...
if __name__ == '__main__':
  ...
  # 
  # library.apply_function(fn=MdFile.split_to_bits, dir_path="/home/vvasuki/vishvAsa/kannaDa/static/padya/DVG/kagga", dry_run=False, source_script=None,  indexed_title_pattern=None)
  # 
