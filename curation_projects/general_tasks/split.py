...
if __name__ == '__main__':
  ...
  # 
  # library.apply_function(fn=MdFile.split_to_bits, dir_path="/home/vvasuki/vishvAsa/sanskrit/content/meta/misconceptions.md", frontmatter_type=MdFile.TOML, dry_run=False, source_script=sanscript.DEVANAGARI,  indexed_title_pattern=None) # 
  # 

  library.apply_function(fn=MdFile.split_to_bits, dir_path="/home/vvasuki/vishvAsa/notes-hugo/content/history/paganology/sino-tibetan/tibeto-burman/chin.md", dry_run=False, source_script=None,  indexed_title_pattern=None)
  # 
