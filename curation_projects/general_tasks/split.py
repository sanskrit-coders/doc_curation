...
if __name__ == '__main__':
  ...
  # library.apply_function(fn=MdFile.split_to_bits, dir_path="/home/vvasuki/vishvAsa/notes-hugo/content/history/paganology/Aryan/satem/indo-iranian/indo-aryan/v2/persons/vijayanagara/0_Pre-founders.md", dry_run=False, source_script=None,  indexed_title_pattern=None)
  # 
