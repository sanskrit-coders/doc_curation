...
ref_dir = "/home/vvasuki/vishvAsa/vedAH/static/yajuH/taittirIyam/sUtram/baudhAyanaH/gRhyam/sUtra-pAThaH/vishvAsa-prastutiH"
...
def fix_filenames():
  ...
  metadata_helper.copy_metadata_and_filename(dest_dir="/home/vvasuki/vishvAsa/vedAH/static/yajuH/taittirIyam/sUtram/baudhAyanaH/gRhyam/sUtra-pAThaH/oldenberg_with_fn", ref_dir=ref_dir, sub_path_id_maker=sub_path_id_maker)


def fix_includes():
  md_files = library.get_md_files_from_path(dir_path="/home/vvasuki/vishvAsa/vedAH/content/yajuH/taittirIyam/sUtram/baudhAyanaH/gRhyam/sUtra-TIkAH", file_pattern="[0-9][0-9]*.md")
...
def fix_oldenberg():
  ...
  base_dir = "/home/vvasuki/vishvAsa/vedAH/static/yajuH/taittirIyam/sUtram/baudhAyanaH/gRhyam/sUtra-pAThaH/oldenberg_with_fn/11"
  # Merge 11, 12
...
if __name__ == '__main__':
  # fix_includes()
  # para_translation.dump_serially(start_url="https://www.wisdomlib.org/hinduism/book/apastamba-grihya-sutra/d/doc116791.html", base_dir="/home/vvasuki/vishvAsa/vedAH/static/yajuH/taittirIyam/sUtram/baudhAyanaH/gRhyam/sUtra-pAThaH/oldenberg_with_fn/", dest_path_maker=oldenberg_dest_path_maker)
  # para_translation.split(base_dir="/home/vvasuki/vishvAsa/vedAH/static/yajuH/taittirIyam/sUtram/baudhAyanaH/gRhyam/sUtra-pAThaH/oldenberg_with_fn/")
  # fix_oldenberg()
  fix_filenames()
  pass
