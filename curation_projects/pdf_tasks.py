...
if __name__ == '__main__':
    ...
    # pdf.split_and_ocr_all(dir_path="/home/vvasuki/Documents/books/granthasangrahaH/jyotiSham/Hamlet's Mill - An Essay on Myth and the Frame of Time - Giorgio de Santillana and Hertha von Dechend (1969).pdf", small_pdf_pages=15)
