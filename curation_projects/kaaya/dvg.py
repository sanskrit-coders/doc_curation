...
def fix_muula():
  # library.apply_function(fn=metadata_helper.add_init_words_to_title, dir_path="/home/vvasuki/vishvAsa/kannaDa/static/padya/DVG/kagga/mUla", target_title_length=30, num_words=2, dry_run=False)
