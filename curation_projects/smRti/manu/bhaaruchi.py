...
def migrate_and_include_commentary(chapter_id):
  ...
  def replacement_maker(text_matched, dest_path):
    ...
    include_line = include_helper.vishvAsa_include_maker(dest_path, h1_level=4, classes=["collapsed"], title="भारुचिः")
...
if __name__ == '__main__':
  ...
  migrate_and_include_commentary(chapter_id="%02d" % 12)
