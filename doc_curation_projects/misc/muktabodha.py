...
if __name__ == '__main__':
  ...
  pass
  muktabodha.fix_lines(dir_path="/home/vvasuki/gitland/vishvAsa/AgamaH_shaivaH/content/shAktaH/daxiNAmnAyaH/AgamaH/lalitA-sahasra-nAma-stotram/sarva-prastutiH.md")
