...
if __name__ == '__main__':
    ...
    # satsangadhaaraa.dump_book(init_url="http://satsangdhara.net/garg/intro-garg.htm", out_path="/home/vvasuki/sanskrit/raw_etexts/purANam/gArga-saMhitA/", overwrite=False)
    # satsangadhaaraa.dump_book(init_url="http://satsangdhara.net/vp/intro-vishnu.htm", out_path="/home/vvasuki/sanskrit/raw_etexts/purANam/viShNu-purANam/", overwrite=False)
    # satsangadhaaraa.dump_book(init_url="http://satsangdhara.net/shiva/intro-shiva.htm", out_path="/home/vvasuki/sanskrit/raw_etexts/purANam/shiva-mahApurANam/", overwrite=False)
    # satsangadhaaraa.dump_book(init_url="http://satsangdhara.net/harivamsh/intro-harivamsh.htm", out_path="/home/vvasuki/sanskrit/raw_etexts/purANam/harivaMsha-purANam/", overwrite=False)
    # satsangadhaaraa.dump_book(init_url="http://satsangdhara.net/upa/intro-vaishnavo.htm", out_path="/home/vvasuki/sanskrit/raw_etexts/veda/misc/upaniShat/vaiShNavI", overwrite=False)
    # satsangadhaaraa.dump_book(init_url="http://satsangdhara.net/upa/intro-shaiva.htm", out_path="/home/vvasuki/sanskrit/raw_etexts/veda/misc/upaniShat/shaivI", overwrite=False)
