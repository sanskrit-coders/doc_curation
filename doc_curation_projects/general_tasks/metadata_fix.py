...
def title_fix():
  ...
  library.apply_function(dir_path="/home/vvasuki/gitland/vishvAsa/mahAbhAratam/content/goraxapura-pAThaH/hindy-anuvAdaH/03_vanaparva/07_tIrthayAtrAparva", fn=metadata_helper.set_title_from_filename, transliteration_target=sanscript.DEVANAGARI, overwrite=True, dry_run=False)
