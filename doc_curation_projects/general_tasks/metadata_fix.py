...
def title_fix():
  ...
  library.apply_function(dir_path="/home/vvasuki/gitland/vishvAsa/purANam_vaiShNavam/content/bhAgavatam/gauDIya-prastutiH/10/", fn=metadata_helper.set_filename_from_title, dry_run=False)
