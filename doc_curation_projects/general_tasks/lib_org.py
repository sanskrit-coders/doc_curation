...
if __name__ == '__main__':
  ...
  arrangement.shift_indices(dir_path="/home/vvasuki/gitland/vishvAsa/rAmAnujIyam/content/tattvam/shAnkhAntarANi/navya-mangala-varadAchAryaH/lekhA-sangrahaH/2/1_saMskRtam", start_index=15, new_index_offset=-2, dry_run=False)
