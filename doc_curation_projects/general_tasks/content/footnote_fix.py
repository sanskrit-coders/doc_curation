...
def fix_footnotes(dir_path):
  ...
  library.apply_function(fn=MdFile.transform, dir_path=dir_path, content_transformer=footnote_helper.fix_sup_footnotes, dry_run=False)
...
if __name__ == '__main__':
  pass
  fix_footnotes(dir_path="/home/vvasuki/gitland/vishvAsa/AgamaH_vaiShNavaH/content/pAncharAtrAgamaH/hayashirShsaH/meta")
