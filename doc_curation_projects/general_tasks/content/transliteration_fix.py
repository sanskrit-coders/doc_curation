...
def fix_anunaasikaadi(dir_path):
...
if __name__ == '__main__':
  ...
  # fix_anunaasikaadi(dir_path="/home/vvasuki/gitland/vishvAsa/kAvyam/content/laxyam/padyam/shrIvaiShNava-kRtam/parAshara-bhaTTaH/guNa-ratna-koshaH.md")
