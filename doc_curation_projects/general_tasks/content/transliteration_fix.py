...
def fix_anunaasikaadi(dir_path, level=0):
  library.apply_function(fn=MdFile.transform, dir_path=dir_path, content_transformer=lambda x, metadata: sanskrit_helper.fix_anunaasikaadi(x, level=level), dry_run=False, silent_iteration=False)
  # library.apply_function(fn=MdFile.transform, dir_path=dir_path, content_transformer=lambda x, metadata: sanskrit_helper.fix_avagrahas(x), dry_run=False, silent_iteration=False)
  # 
...
if __name__ == '__main__':
  ...
  # devanaagarify(dir_path="/home/vvasuki/gitland/vishvAsa/AgamaH_vaiShNavaH/content/vaikhAnasaH/AgamaH/sangrahAH/pratiShThAnukramaNikA.md", source_script="telugu")
  ...
  devanaagarify(dir_path="/home/vvasuki/gitland/vishvAsa/rAmAnujIyam/static/tattvam/venkaTa-nAtha-shAkhA/venkaTanAthaH/tattva-muktA-kalApaH/sarvASh_TIkAH/1_jaDa-dravya-saraH/017_dvedhA_bhUtAni.md", source_script="kannada")
  ...
  # devanaagarify(dir_path="/home/vvasuki/gitland/vishvAsa/rAmAnujIyam/static/tattvam/venkaTa-nAtha-shAkhA/venkaTanAthaH/tattva-muktA-kalApaH/sarvASh_TIkAH/1_jaDa-dravya-saraH/017_dvedhA_bhUtAni.md", source_script=sanscript.TAMIL)
