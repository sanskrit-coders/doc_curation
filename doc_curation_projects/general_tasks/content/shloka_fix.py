...
def details_fix(dir_path):
  ...
  # library.apply_function(fn=MdFile.transform, dir_path=dir_path, content_transformer=lambda c, m: details_helper.shlokas_to_muula_viprastuti_details(content=c, pattern=patterns.PATTERN_NUM_SUTRA, shloka_processor=lambda x: x.replace("\n\n", "  \n")))
...
if __name__ == '__main__':
  pass
  # shloka_formatting()
  details_fix(dir_path="/home/vvasuki/gitland/vishvAsa/kAvyam/content/laxyam/padyam/stotram/shivaH/bhakti-stotram_avadhUta-siddha-virachitam.md")
