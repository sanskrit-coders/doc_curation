...
if __name__ == '__main__':
  ...
  library.apply_function(fn=MdFile.transform, dir_path="/home/vvasuki/gitland/vishvAsa/rAmAnujIyam/static/tattvam/venkaTa-nAtha-shAkhA/venkaTanAthaH/tattva-muktA-kalApaH/sarvASh_TIkAH/1_jaDa-dravya-saraH/005_AvApodvApatassyuH_katikati.md", content_transformer=lambda x, *args, **kwargs: ocr_helper.fix_hyphenation(x), dry_run=False)
