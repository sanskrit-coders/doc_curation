...
if __name__ == '__main__':
  ...
  library.apply_function(fn=MdFile.transform, dir_path="/home/vvasuki/gitland/vishvAsa/rAmAnujIyam/content/tattvam/shAnkhAntarANi/navya-mangala-varadAchAryaH/lekhA-sangrahaH/2/3_APPENDIX/3_anUktiH.md", content_transformer=lambda x, *args, **kwargs: ocr_helper.fix_hyphenation(x), dry_run=False)
