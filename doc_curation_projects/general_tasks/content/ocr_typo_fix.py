...
if __name__ == '__main__':
  ...
  library.apply_function(fn=MdFile.transform, dir_path="/home/vvasuki/gitland/vishvAsa/rAmAnujIyam/content/tattvam/yAmunaH/siddhi-trayam/tirunAngUr-aNNangarAchArya-vyAkhyAnam/01_AtmasiddhiH.md", content_transformer=lambda x, *args, **kwargs: sanscript.SCHEMES[sanscript.DEVANAGARI].redo_upapada_sandhis(x), dry_run=False)
