...
if __name__ == '__main__':
    ...
    doc_curation.pdf.drive_ocr.split_and_ocr_all( dir_path="/home/vvasuki/Documents/books/granthasangrahaH/kalpaH/Baudhayana-Prayoga-Ratna-Mala.pdf", small_pdf_pages=5, detext=False)
