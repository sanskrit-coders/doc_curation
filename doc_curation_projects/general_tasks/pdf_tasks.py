...
if __name__ == '__main__':
    ...
    # drive_ocr.split_and_ocr_on_drive(pdf_path="/run/media/vvasuki/vData/text/granthasangrahaH/kAvyam/bannanje/tarka-kesarI_paDamunnUru-nArAyaNAchAryaH.pdf", small_pdf_pages=10, start_page=1, detext=False)

    # drive_ocr.split_and_ocr_on_drive(pdf_path="/run/media/vvasuki/vData/text/granthasangrahaH/kAvyam/bannaje/tarka-kesarI_paDamunnUru-nArAyaNAchAryaH.pdf", small_pdf_pages=10, start_page=264, end_page=None, detext=True)
    # for i in range(1,4):
    ...
    drive_ocr.split_and_ocr_all(dir_path="/run/media/vvasuki/vData/text/granthasangrahaH/AgamaH/vaiShNavaH/svAmi-nArAyaNa-sampradAyaH", small_pdf_pages=5, detext=False, file_pattern="[!_]*.pdf")
