...
if __name__ == '__main__':
    ...
    drive_ocr.split_and_ocr_all(dir_path="/run/media/vvasuki/vData/text/granthasangrahaH/AgamaH/shiavaH/soma-shambhu-paddhatiH", small_pdf_pages=10, detext=True)
