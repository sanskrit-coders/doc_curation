...
if __name__ == '__main__':
    ...
    doc_curation.pdf.drive_ocr.split_and_ocr_all( dir_path="/home/vvasuki/Documents/books/granthasangrahaH/kAvyam/champUH/Vishwagunadarsh_1906_NSP.pdf", small_pdf_pages=2, detext=True)
