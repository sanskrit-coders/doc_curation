...
if __name__ == '__main__':
    ...
    drive_ocr.split_and_ocr_all(dir_path="/run/media/vvasuki/vData/text/granthasangrahaH/kAvyam/shrIvaiShNavakRtam/sankalpa-sUryodayaH", small_pdf_pages=10, detext=True)
