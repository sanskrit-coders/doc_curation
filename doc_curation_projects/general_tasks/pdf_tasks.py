...
if __name__ == '__main__':
    ...
    doc_curation.pdf.drive_ocr.split_and_ocr_all(dir_path="/run/media/vvasuki/vData/text/granthasangrahaH/kAvyam/shrIvaiShNavakRtam", small_pdf_pages=10, detext=False)
