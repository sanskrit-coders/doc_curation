...
if __name__ == '__main__':
    ...
    drive_ocr.split_and_ocr_all(dir_path="/media/vvasuki/vData/text/granthasangrahaH/AgamaH/brAhmaH/sachchidAnandendraH/en", small_pdf_pages=10, detext=True, file_pattern="[!_]*.pdf")
