...
if __name__ == '__main__':
    ...
    drive_ocr.split_and_ocr_all(dir_path="/media/vvasuki/vData/text/granthasangrahaH/AgamaH/vaiShNavaH/shrIvaiShNavaH/", small_pdf_pages=10, detext=False, file_pattern="[!_]*.pdf")
