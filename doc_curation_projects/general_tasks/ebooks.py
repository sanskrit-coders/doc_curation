...
def rAmAnujIyam():
  ...
  # epub.epub_from_full_md("/home/vvasuki/gitland/vishvAsa/rAmAnujIyam/content/tattvam/yAmunaH/Agama-prAmANyam/sarva-prastutiH", out_path=os.path.join(out_path, "yAmunaH/Agama-prAmANyam"),css_path=CSS_PATH, appendix=appendix_dg, file_split_level=2)
