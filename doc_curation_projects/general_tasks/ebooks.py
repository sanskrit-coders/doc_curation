...
def rAmAnujIyam():
  ...
  make_epub("/home/vvasuki/gitland/vishvAsa/rAmAnujIyam/content/kriyA/venkaTa-nAtha-shAkhA/tirumalai-tAtAryaH_sampradAya-pradIpaH", metadata={"author": "tirumalai-tAtAryaH"}, file_split_level=1, detail_pattern_to_remove=r"मूलम्.*|.*\(सं\).*", out_path=out_path) # TODO images
