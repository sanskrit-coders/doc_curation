...
def update_blog_files():
  ...
  paths_in = glob.glob("/home/vvasuki/gitland/vishvAsa/**/MT*/**/*.md", recursive=True)
  file_helper.substitute_with_latest(paths_in=paths_in, latest_file_paths=latest_file_paths, dry_run=False)


if __name__ == '__main__':
  update_blog_files()
  # files = glob.glob("/home/vvasuki/gitland/vishvAsa/vedAH/content/yajuH/taittirIyam/brAhmaNam/bhaTTa-bhAskara-bhAShyam/3/1/*/*.md")
