...
if __name__ == '__main__':
  ...
  # library.apply_function(fn=content_processor.replace_texts, dir_path="/home/vvasuki/sanskrit/raw_etexts/vedaH/yajur/taittirIya/sAyaNa", patterns=["ḍ(?=[A-Z])"], replacement="d. ")
