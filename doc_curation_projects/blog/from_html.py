...
def word_clouds():
  ...
  library.dump_word_cloud(src_path="/home/vvasuki/gitland/hindu-comm/weblogs/manasataramgini",
                          dest_path="word-clouds/general.png", stop_words=stop_words)
  library.dump_word_cloud(src_path="/home/vvasuki/gitland/hindu-comm/weblogs/padmavajra", dest_path="word-clouds/general.png",
                          stop_words=stop_words)
  library.dump_word_cloud(src_path="/home/vvasuki/gitland/hindu-comm/weblogs/cestlaviepriya",
                          dest_path="word-clouds/general.png", stop_words=stop_words)


def dump_wordpress():
  wordpress.scrape_index(url="https://manasataramgini.wordpress.com/the-complete-index/", dry_run=False, dir_path="/home/vvasuki/gitland/hindu-comm/weblogs/manasataramgini")
  wordpress.scrape_index(url="https://padmavajra.net/index-of-posts/", dry_run=False, dir_path="/home/vvasuki/gitland/hindu-comm/weblogs/padmavajra/")
  wordpress.scrape_index(url="https://vriitrahan.wordpress.com/2021/07/21/archive/", dry_run=False, dir_path="/home/vvasuki/gitland/hindu-comm/weblogs/vriitrahan/")
  wordpress.scrape_index(url="https://aryaakasha.com/unfiltered-archive/", dry_run=False, dir_path="/home/vvasuki/gitland/hindu-comm/weblogs/aryaakasha/")
  wordpress.scrape_index(url="https://cestlaviepriya.wordpress.com/index/", dry_run=False, dir_path="/home/vvasuki/gitland/hindu-comm/weblogs/cestlaviepriya")
...
def dump_wordpress_monthly():
  ...
  wordpress.scrape_monthly_indexes(url="https://animeshnagarblog.wordpress.com/", dir_path="/home/vvasuki/gitland/hindu-comm/weblogs/animeshnagarblog", init_year_month_str=init_year_month_str, dry_run=False)
  wordpress.scrape_monthly_indexes(url="https://aryanthought.wordpress.com/", dir_path="/home/vvasuki/gitland/hindu-comm/weblogs/aryanthought", init_year_month_str=init_year_month_str, dry_run=False)
  ...
  #   wordpress.scrape_monthly_indexes(url="https://balramshukla.wordpress.com/", dry_run=False, dir_path="/home/vvasuki/gitland/hindu-comm/weblogs/balramshukla")
  pass
...
def dump_substack():
  ...
  substack.scrape_free_articles_from_index_anchors(url="https://rasajournal.substack.com/archive", dir_path="/home/vvasuki/gitland/hindu-comm/weblogs/rasajournal", dry_run=False)
  substack.scrape_free_articles_from_index_anchors(url="https://ekavali.substack.com/archive", dir_path="/home/vvasuki/gitland/hindu-comm/weblogs/ekavali", dry_run=False)
  substack.scrape_free_articles_from_index_anchors(url="https://bharadvajatmaja.substack.com/archive", dir_path="/home/vvasuki/gitland/hindu-comm/weblogs/bharadvajatmaja", dry_run=False)
  substack.scrape_free_articles_from_index_anchors(url="https://machiavellianhindu.substack.com/archive", dir_path="/home/vvasuki/gitland/hindu-comm/weblogs/machiavellianhindu", dry_run=False)
  pass
