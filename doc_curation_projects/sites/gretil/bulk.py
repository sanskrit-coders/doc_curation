...
src_dir_base = "/home/vvasuki/gitland/sanskrit/raw_etexts/mixed/gretil-skt/gretil.sub.uni-goettingen.de/gretil"
dest_dir_base = "/home/vvasuki/gitland/sanskrit/raw_etexts/mixed/gretil_devanAgarI/"
...
def process_dravidian():
  for subdir in ["malayalam", "tamil"]:
    devanagarify(src_dir=os.path.join(src_dir_base, f"4_drav/{subdir}"), dest_dir=os.path.join(dest_dir_base, f"4_drav/{subdir}"), overwrite=False)
