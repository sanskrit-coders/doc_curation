...
source_file = "/home/vvasuki/indic-texts/raw_etexts_misc/quasi-hindi/tulasIdAsa/gp_raw/shri-ramchritmanas-satik.html"
dest_file = "/home/vvasuki/gitland/vishvAsa/bhAShAntaram/content/prakIrNAryabhAShAH/padya/tulasIdAsa/rAmacharitamAnasa/goraxapura-pATha/hindy-anuvAda_mUla-prastutiH.md"
dest_path = dest_file.replace(".md", "")

detail_map = OrderedDict([
  ("सूचना (हिन्दी)", [""]),
  ("भागसूचना", ["Main-Heading-4", "Vishram", "Heading"]),
  ("विषय (हिन्दी)", ["Numbers"]),
  ("मूल (चौपाई)", ["Shlok-Color--1-1", "Shlok-Color--1", "para-style-override-4", "Shlok-Color--1-2", "Shlok-Color--1-4", "Shlok-Color--1-5", "Shlok-Color--1-3"]),
  ("मूल (दोहा)", ["Shlok-Color-2", "Shlok-Color--1",]),
  ("मूल (श्लोक)", ["SHLOK-Black", "Shlok-New"]),
  ("अनुवाद (हिन्दी)", ["TXT", "No-Paragraph-Style", "Text-18-6"]),
