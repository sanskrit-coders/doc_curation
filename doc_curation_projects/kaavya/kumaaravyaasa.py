...
def get_doc_data(parva_num):
  ...
  doc_data = sheets.IndexSheet(spreadhsheet_id="1N9klz4d4sr5BRDlKU1jTCwZS9tC1s_h2HEvChIH5CAM", worksheet_name=str(parva_num), id_column="Id", google_key='/home/vvasuki/gitland/vvasuki-git/sysconf/kunchikA/google/proofing/service_account_key.json')
