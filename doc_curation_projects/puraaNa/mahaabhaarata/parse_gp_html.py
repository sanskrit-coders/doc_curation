...
def dump_all(base_path, urls=None, dry_run=False):
  ...
  # arrangement.fix_index_files(dir_path=base_path)
  # arrangement.fix_index_files(dir_path="/home/vvasuki/gitland/vishvAsa/purANam/content/mahAbhAratam/meta/gItA-mudraNAlayAvRttiH")
  pass
