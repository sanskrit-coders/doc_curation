...
def dump(browser):
  ...
  # parankusha.get_structured_text(browser=browser, start_nodes=["विद्यास्थानानि", "वेदाः", "कृष्णयजुर्वेदः-तैत्तिरीयशाखा(सारस्वतपाठः)",  "ब्राह्मणम्"], base_dir="/home/vvasuki/sanskrit/raw_etexts/veda/taittirIya/mUlam/brAhmaNam", unit_info_file=os.path.join(os.path.dirname(book_data.__file__), "data/book_data/vedaH/taittirIya/mUlam/brAhmaNa.json"))
  ...
  # parankusha.get_structured_text(browser=browser, start_nodes=["विद्यास्थानानि", "वेदाः", "कृष्णयजुर्वेदः-तैत्तिरीयशाखा(सारस्वतपाठः)",  "आरण्यकम्"], base_dir="/home/vvasuki/sanskrit/raw_etexts/veda/taittirIya/mUlam/AraNyakam", unit_info_file=os.path.join(os.path.dirname(book_data.__file__), "data/book_data/vedaH/taittirIya/mUlam/AraNyaka.json"))
