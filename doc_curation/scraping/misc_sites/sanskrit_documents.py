...
def dump_markdown(src_file, dest_file):
  ...
  metadata["title"] = sanscript.transliterate(data=metadata["itxtitle"], _from=sanscript.OPTITRANS,
...
def markdownify_all(src_dir, dest_dir, overwrite=False):
