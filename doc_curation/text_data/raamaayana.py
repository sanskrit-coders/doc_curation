...
kaanda_indices = range(1, 8)

def get_sarga_list_andhra(kaanda_index):
    sarga_list = []
    if kaanda_index == 1:
...
def get_sarga_list_baroda(kaanda_index):
    sarga_list = []
    if kaanda_index == 1:
        ...
        sarga_list = range(1, 72)
    elif kaanda_index == 4:
        sarga_list = range(1, 67)
    elif kaanda_index == 5:
        sarga_list = range(1, 67)
    elif kaanda_index == 6:
        sarga_list = range(1, 117)
    elif kaanda_index == 7:
        sarga_list = range(1, 112)
    return sarga_list
